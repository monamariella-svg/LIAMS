  ...
  return (
    <section className="rounded-xl border-2 border-liams-navy/20 bg-liams-navy/5 p-6">
      ...
      <p className="mt-1 text-sm text-gray-600">
        Une fois votre bulletin n°3, votre CV (et votre justificatif Xtras si
        applicable) déposés, soumettez votre dossier pour vérification.
      </p>
      ...
      <form action={formAction} className="mt-4">
        ...
        {state?.dossierComplet && (
          <p className="mb-3 rounded-lg bg-liams-teal/10 px-4 py-3 text-sm font-medium text-liams-teal">
            Votre dossier est complet ! Il sera analysé et validé par notre équipe sous 24 à 48h.
          </p>
        )}
        <button
          type="submit"
